...
export class DebugInstanceAPI extends InstanceAPI {
    ...
    public async create(hashType: HashType, hashes: string[], instanceType?: string | undefined): Promise<string | null> {
        const uuid = crypto.randomUUID();
        
        console.log(`Creating instance ${uuid} of type ${instanceType} with ${hashes.length} hash(es) of type ${hashType}`);

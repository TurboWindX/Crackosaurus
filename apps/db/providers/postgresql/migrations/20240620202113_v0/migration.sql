...
CREATE TABLE "Wordlist" (
    ...
    CONSTRAINT "Wordlist_pkey" PRIMARY KEY ("WID")
);
...
-- AddForeignKey
ALTER TABLE "Job" ADD CONSTRAINT "Job_wordlistId_fkey" FOREIGN KEY ("wordlistId") REFERENCES "Wordlist"("WID") ON DELETE SET NULL ON UPDATE CASCADE;
